...
import AreaChartElevated from "./widget";
import { areFromSameDay, getOnlyDate, formatDate } from "../../utils/dateUtils";
...
console.log(lineDataFiltered);

pulse = pulse / lineData.length;
console.log("Pulse: ", pulse);

export const widget = () => (
  <AreaChartElevated areaData={areaDataFiltered} lineData={lineDataFiltered} />
);
widget.story = {
  name: "Widget",
};
